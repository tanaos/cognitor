...
export default function TrainingModelUsageChart({ data }: {
    data: { model: string; runs: number }[];
}) {
    return (
        <div className={styles.card}>
            <h3 className={styles.title}>Training runs per model</h3>
            {data.length === 0 ? (
